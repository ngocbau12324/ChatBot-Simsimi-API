...
/*------------------------------------------------API SIMSIMI-------------------------------------------------------------*/    
    private String chatSimsimi(String text){
        String ulr = "https://api.simsimi.net/v2/?text="+text+"?&lc=vn";
        String ans = "";
        try {
...
/*------------------------------------------------API TỈ GIÁ NGOẠI TỆ-------------------------------------------------------------*/  
   private String DoiTien(double money, String baseCurren, String desCurren) {
        String apikey = "bd48de20-5777-11ec-9c10-4f575139711f";
        String url = "https://freecurrencyapi.net/api/v2/latest?apikey=" + apikey + "&base_currency=" + baseCurren;
        String ketQua;
        try {
            Connection.Response respone = Jsoup.connect(url)
